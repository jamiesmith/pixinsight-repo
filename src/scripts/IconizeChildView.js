 ...
 */
class IconizeCloneWithSuffixDialog extends Dialog
{
   constructor()
   {
      super();
        ...
        //
        this.scaledMinWidth = 540;
        this.scaledMaxWidth = 540;

        // set the minimum height of the dialog
        //
        // this.scaledMinHeight = 500;
        // this.scaledMaxHeight = 500;
        ...
        this.title.text = "<b>Iconize Matching Child or Parent Image(s)</b>" +
            ...
            "<br>Note: <i>If the suffix is empty the target view itself will be iconized</i>" +
            "<br><br><b>Usage:</b>" +
